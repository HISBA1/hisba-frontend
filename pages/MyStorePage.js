    ...
    <div className={styles.storeContainer}>
      ...
      >
        ...
        >
          ...
          {store && typeof store.average_rating === 'number' && store.average_rating > 0 ? (
    [...Array(Math.floor(Number(store.average_rating)))].map((_, i) => (
              ...
              <>
                ...
                <div className={styles.productDetails}>
                  ...
                  <div className={styles.productPriceTag}>
                    <span className={styles.productPrice}>{`ILS${product.price} Per Kg`}</span>
                    <span className={styles.productQuantity}>{`Quantity: ${product.quantity} Kg `}</span>
                  </div>
